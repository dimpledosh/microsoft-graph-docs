...
-->
``` http
POST /accessPackageResources/{accessPackageResourcesId}/accessPackageResourceEnvironment/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/accessPackageResources/{accessPackageResourcesId}/accessPackageResourceEnvironment/$ref
